---
title: "Making Eleventy Builds Faster"
date: 2026-05-11
description: "How to audit Eleventy build benchmarks and cut build time by caching custom filters and optimizing network fetches."
postType: article
tags: ["eleventy", "performance", "developer-experience", "tutorial"]
featured_image: /assets/images/posts/eleventy-build-performance.jpg
...
As your Eleventy site grows, build times can increase. What started as a fast 2-second build can become sluggish as you add more posts, filters, and data fetching. This guide shows you how to audit build benchmarks and optimize performance.

Eleventy prints benchmark data at the end of every build if anything is slow enough to measure. Pay attention to this output:
...
Eight and a half seconds on a single filter! That's 64% of the total build time.
