---
title: "Building an IndieAuth Comment System"
date: 2026-01-06
description: "How to build a comment system for a static site using IndieAuth and Netlify Functions, storing comments in your git repository."
postType: article
tags: ["indieweb", "indieauth", "netlify", "serverless", "tutorial"]
featured_image: /assets/images/posts/indieauth-comments.jpg
...
This guide shows you how to build a comment system for a static site using IndieAuth and Netlify Functions. Comments are stored in your git repository, giving you full ownership without third-party services.

## Why Build Your Own?

Third-party comment systems like Disqus are convenient, but they come with trade-offs:
- You give away conversations and community engagement
- User data lives on someone else's servers
- You're locked into their platform
- Added bloat and tracking

Building your own comment system means:
- Full ownership of your data
- No tracking or ads
- Minimal JavaScript
- Comments stored in your git repository
- Authentication via users' own websites (IndieAuth)

## The Architecture

This approach uses:
- **Eleventy** for the static site
- **Netlify Functions** for serverless backend
- **Git repository** for comment storage
